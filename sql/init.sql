...
) ENGINE = InnoDB AUTO_INCREMENT = 417 COMMENT = '数据历史表';
...
INSERT INTO `_resource` (`id`,`accessControlTable`,`resourceHook`,`pageId`,`actionId`,`desc`,`resourceType`,`appDataSchema`,`resourceData`,`requestDemo`,`responseDemo`,`operation`,`operationByUserId`,`operationByUser`,`operationAt`) VALUES (9,NULL,NULL,'allPage','userInfo','✅获取用户信息','service',NULL,'{\"service\": \"user\", \"serviceFunction\": \"userInfo\"}','','','update',NULL,NULL,'2022-09-18T12:42:42+08:00');
...
INSERT INTO `_resource` (`id`,`accessControlTable`,`resourceHook`,`pageId`,`actionId`,`desc`,`resourceType`,`appDataSchema`,`resourceData`,`requestDemo`,`responseDemo`,`operation`,`operationByUserId`,`operationByUser`,`operationAt`) VALUES (13,NULL,NULL,'designAssignment','updateAssignment','✅更新作业','sql','{}','{\"table\": \"article\", \"operation\": \"jhUpdate\"}','','','update',NULL,NULL,'2022-09-18T12:34:35+08:00');
INSERT INTO `_resource` (`id`,`accessControlTable`,`resourceHook`,`pageId`,`actionId`,`desc`,`resourceType`,`appDataSchema`,`resourceData`,`requestDemo`,`responseDemo`,`operation`,`operationByUserId`,`operationByUser`,`operationAt`) VALUES (14,NULL,NULL,'designAssignment','selectAssignment','✅查询作业','sql','{}','{\"table\": \"article\", \"operation\": \"select\"}','','','update',NULL,NULL,'2022-09-18T12:34:22+08:00');
INSERT INTO `_resource` (`id`,`accessControlTable`,`resourceHook`,`pageId`,`actionId`,`desc`,`resourceType`,`appDataSchema`,`resourceData`,`requestDemo`,`responseDemo`,`operation`,`operationByUserId`,`operationByUser`,`operationAt`) VALUES (15,NULL,NULL,'articleManagement','selectItemList','✅作业管理-查询列表(不包含内容)','sql','{}','{\"table\": \"article\", \"operation\": \"select\"}','','','update','vscode','vscode','2022-09-18T12:42:40+08:00');
INSERT INTO `_resource` (`id`,`accessControlTable`,`resourceHook`,`pageId`,`actionId`,`desc`,`resourceType`,`appDataSchema`,`resourceData`,`requestDemo`,`responseDemo`,`operation`,`operationByUserId`,`operationByUser`,`operationAt`) VALUES (16,NULL,NULL,'articleManagement','jhUpdateItem','✅作业编辑-更新成员','sql','{}','{\"table\": \"article\", \"operation\": \"jhUpdate\"}','','','update','vscode','vscode','2022-09-18T12:29:44+08:00');
...
INSERT INTO `_resource` (`id`,`accessControlTable`,`resourceHook`,`pageId`,`actionId`,`desc`,`resourceType`,`appDataSchema`,`resourceData`,`requestDemo`,`responseDemo`,`operation`,`operationByUserId`,`operationByUser`,`operationAt`) VALUES (27,NULL,NULL,'assignmentHomework','selectUserAssignmentList','✅文章作业-查看用户作业','sql','{}','{ \"table\": \"assignment\", \"operation\": \"select\", \"where\": {\"userId\": \"userInfo.userId\"} }','','','update',NULL,NULL,'2022-09-18T12:42:42+08:00');
INSERT INTO `_resource` (`id`,`accessControlTable`,`resourceHook`,`pageId`,`actionId`,`desc`,`resourceType`,`appDataSchema`,`resourceData`,`requestDemo`,`responseDemo`,`operation`,`operationByUserId`,`operationByUser`,`operationAt`) VALUES (28,NULL,NULL,'assignmentHomework','selectArticleInfo','✅文章作业-查看用户作业','sql','{}','{ \"table\": \"article\", \"operation\": \"select\"}','','','update',NULL,NULL,'2022-09-18T12:34:43+08:00');
INSERT INTO `_resource` (`id`,`accessControlTable`,`resourceHook`,`pageId`,`actionId`,`desc`,`resourceType`,`appDataSchema`,`resourceData`,`requestDemo`,`responseDemo`,`operation`,`operationByUserId`,`operationByUser`,`operationAt`) VALUES (29,NULL,'{ \"before\": [{\"service\": \"assignment\", \"serviceFunction\": \"appendAssignIdToActionData\"}], \"after\": [] }','assignmentHomework','insertItem','✅文章作业-创建作业','sql','{}','{ \"table\": \"assignment\", \"operation\": \"jhInsert\" }','','','update',NULL,NULL,'2022-09-18T12:34:50+08:00');
INSERT INTO `_resource` (`id`,`accessControlTable`,`resourceHook`,`pageId`,`actionId`,`desc`,`resourceType`,`appDataSchema`,`resourceData`,`requestDemo`,`responseDemo`,`operation`,`operationByUserId`,`operationByUser`,`operationAt`) VALUES (30,NULL,NULL,'assignmentHomework','updateItem','✅文章作业-更新作业','sql','{}','{ \"table\": \"assignment\", \"operation\": \"jhUpdate\" }','','','update',NULL,NULL,'2022-09-18T12:35:01+08:00');
...
INSERT INTO `article` (`id`,`articleId`,`articleTitle`,`articleAssignment`,`articleAssignmentWithAnswer`,`operation`,`operationByUserId`,`operationByUser`,`operationAt`,`articleAssignmentPublishStatus`,`articlePublishStatus`) VALUES (10010,'10003','66666---',NULL,NULL,'update','admin','adminName','2022-09-18T02:57:07+08:00',NULL,'deleted');
...
INSERT INTO `article` (`id`,`articleId`,`articleTitle`,`articleAssignment`,`articleAssignmentWithAnswer`,`operation`,`operationByUserId`,`operationByUser`,`operationAt`,`articleAssignmentPublishStatus`,`articlePublishStatus`) VALUES (10012,'10005','342124','[{\"id\":\"singleSelect_GNcE88pR\",\"component\":{\"title\":\"单选\",\"type\":\"singleSelect\",\"outline\":\"2+3=？\",\"property\":{\"selectOptionList\":[{\"value\":\"A5\"},{\"value\":\"B 6\"}]},\"icon\":\"mdi-checkbox-marked-circle\"},\"upload\":[\"img\",\"audio\"],\"file\":{\"img\":\"\",\"audio\":\"\"},\"answerData\":{}}]','[{\"id\":\"singleSelect_GNcE88pR\",\"component\":{\"title\":\"单选\",\"type\":\"singleSelect\",\"outline\":\"2+3=？\",\"property\":{\"selectOptionList\":[{\"value\":\"A5\"},{\"value\":\"B 6\"}]},\"icon\":\"mdi-checkbox-marked-circle\"},\"upload\":[\"img\",\"audio\"],\"file\":{\"img\":\"\",\"audio\":\"\"},\"answerData\":{\"selected\":\"A5\"}}]','jhUpdate','admin','adminName','2022-09-18T03:52:06+08:00','publish',NULL);
...
CREATE TABLE `assignment` (
  ...
  `operationAt` varchar(255) DEFAULT NULL COMMENT '操作时间; E.g: 2021-05-28T10:24:54+08:00',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 436;
